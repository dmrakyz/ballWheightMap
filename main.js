...
const GROUND_TEXTURE_PATH = 'images/groundTextures/grassTex.jpg';
...
const skyTex = new THREE.TextureLoader().load('images/skyTextures/stars.png');
...
const groundMat = createTexturedMaterial(GROUND_TEXTURE_PATH, 64, 64);
